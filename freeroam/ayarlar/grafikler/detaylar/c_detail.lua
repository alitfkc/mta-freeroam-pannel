...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('ayarlar/grafikler/detaylar/images/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('ayarlar/grafikler/detaylar/images/detail35T.png', "dxt3")
	...
	if not bAllValid then
		...
		engineRemoveShaderFromWorldTexture ( paveDirtyShader, "snipercrosshair" )
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "ayarlar/grafikler/detaylar/fx/detail.fx", 1, 100 )
	if shader then
