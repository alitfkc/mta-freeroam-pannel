...
local filmDepthEnable = true
            -- Грязь
	local texturegrun = {
			"predator92body128", "remap", "monsterb92body256a", "monstera92body256a", "andromeda92wing","fcr90092body128",
...
function startCarPaint()
		if cpEffectEnabled then return end
		    -- Шeйдeра
		     myShader, tec = dxCreateShader ( "ayarlar/grafikler/arababoyasi/file/car_paint.fx",1 ,renderDistance ,false)
		     myWind, tec = dxCreateShader ( "ayarlar/grafikler/arababoyasi/file/windows.fx",1 ,renderDistance ,false)
		     myFara, tec = dxCreateShader ( "ayarlar/grafikler/arababoyasi/file/fara.fx",1 ,renderDistance ,false)
		     carbon, tec = dxCreateShader ( "ayarlar/grafikler/arababoyasi/file/carbon.fx",1 ,renderDistance ,false)

		if myShader then
			outputConsole( "Using technique " .. tec )
            -- Тeкстура
			textureCube = dxCreateTexture ( "ayarlar/grafikler/arababoyasi/file/images/reflx.dds" )
			textureWind = dxCreateTexture ( "ayarlar/grafikler/arababoyasi/file/images/reflx.dds" )
			textureCarb = dxCreateTexture ( "ayarlar/grafikler/arababoyasi/file/images/reflx.dds" )
			textureFringe = dxCreateTexture ( "ayarlar/grafikler/arababoyasi/file/images/ColorRamp01.png" )
			-- Шeйдeр
