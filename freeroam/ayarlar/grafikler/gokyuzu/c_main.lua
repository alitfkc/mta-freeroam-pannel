...
function startShaderResource()
	...
	skydome.txd = engineLoadTXD( 'ayarlar/grafikler/gokyuzu/tex/skydome_object.txd' )
	engineImportTXD( skydome.txd, skydome.modelID)
	skydome.dff = engineLoadDFF( 'ayarlar/grafikler/gokyuzu/dff/skydome_object.dff', skydome.modelID )
	...
	skydome.shader = dxCreateShader ( "ayarlar/grafikler/gokyuzu/fx/skydome.fx", 0, 0, false, "object" )
	skydome.clear = dxCreateShader ( "ayarlar/grafikler/gokyuzu/fx/shader_clear.fx", 0, 0, false )
	
	if skydome.angular then
		skydome.transform = dxCreateShader ( "ayarlar/grafikler/gokyuzu/fx/transform.fx", 0, 0, false )
	end
	
	skydome.texture = dxCreateTexture( "ayarlar/grafikler/gokyuzu/tex/skydome.jpg", "dxt5" )
